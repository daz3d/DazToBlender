...
def load_config():
    ...
    return data["Custom Path"], data["Use Custom Path"]


def update_init():
    custom_path, use_custom = load_config()
    ...
    if use_custom:
        ...
        cp = DtbProperties.CustomPathProperties
        ...
        bpy.types.Scene.dtb_custom_path = PointerProperty(type=cp)
